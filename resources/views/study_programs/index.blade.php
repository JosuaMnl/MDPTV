...
@section('content')
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-danger btn-hapus" data-id="{{ $item->id }}"
                                    data-name-study_programs="{{ $item->nama_prodi }}" data-toggle="modal"
    ...
    <script>
        ...
        $('.btn-hapus').click(function() {
            ...
            $('#formDelete').attr('action', '/study_programs/' + id);

            let nama_prodi = $(this).attr('data-name-study_programs');
            $('#mb-konfirmasi').text('Apakah anda yakin ingin menghapus data prodi ' + nama_prodi + '?');
        })
